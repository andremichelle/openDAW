...
import BoxStateRow from "./box_state_table";
import PresenceRow from "./presence_table";
import RoomRow from "./room_table";
import RoomAssetRow from "./room_asset_table";
...
const tablesSchema: any = __schema({
  box_state: __table({
    ...
    constraints: [
      { name: 'box_state_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, BoxStateRow),
  presence: __table({
    name: 'presence',
    ...
    constraints: [
      { name: 'presence_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, PresenceRow),
  room: __table({
    name: 'room',
  ...
  room_asset: __table({
    ...
    constraints: [
      { name: 'room_asset_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, RoomAssetRow),
  room_participant: __table({
    ...
    constraints: [
      { name: 'room_participant_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, RoomParticipantRow),
  webrtc_signal: __table({
    name: 'webrtc_signal',
    indexes: [
      { name: 'id', algorithm: 'btree', columns: [
        'id',
...
const reducersSchema = __reducers(
  __reducerSchema("box_create", BoxCreateReducer),
  __reducerSchema("box_delete", BoxDeleteReducer),
  __reducerSchema("box_update", BoxUpdateReducer),
