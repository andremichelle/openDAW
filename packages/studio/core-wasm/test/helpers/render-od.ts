...
const PROJECTS = path.resolve(__dirname, "../fixtures/projects")
...
// Render `name`.od (from fixtures/projects) for `quanta` render quanta. Loads every AudioFileBox via the engine's
