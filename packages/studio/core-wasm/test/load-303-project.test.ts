// End-to-end: a REAL serialized project (fixtures/projects/303.od) with scripted devices (Spielwerk + Apparat)
...
const OD = path.resolve(__dirname, "./fixtures/projects/303.od")
