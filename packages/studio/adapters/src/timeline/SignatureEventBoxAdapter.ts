...
export class SignatureEventBoxAdapter implements BoxAdapter, Event {
    static readonly Comparator: Comparator<SignatureEventBoxAdapter> = (a, b) => a.position - b.position
