...
import {BrickDeviceBoxAdapter} from "./devices/audio-effects/BrickDeviceBoxAdapter"
...
export class BoxAdapters implements Terminable {
    ...
    #create(unknownBox: Box): BoxAdapter {
        return asDefined(unknownBox.accept<BoxVisitor<BoxAdapter>>({
            ...
            visitBrickDeviceBox: (box: BrickDeviceBox) => new BrickDeviceBoxAdapter(this.#context, box),
