import {LfoModulatorBox, ModulationBox, RootBox, StepsModulatorBox} from "@opendaw/studio-boxes"
...
export namespace Modulators {
    ...
    const attach = (context: BoxAdaptersContext, box: LfoModulatorBox | StepsModulatorBox, label: string): void => {
    ...
    export const assign = (context: BoxAdaptersContext,
                           modulator: LfoModulatorBox | StepsModulatorBox,
