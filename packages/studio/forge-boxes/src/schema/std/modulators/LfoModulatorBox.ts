...
export const LfoModulatorBox: BoxSchema<Pointers> = ModulatorFactory.createModulator("LfoModulatorBox", {
    10: {
        type: "int32", name: "shape", pointerRules: ModulatorParameterPointerRules, value: 0,
        constraints: {values: [0, 1, 2, 3, 4]}, unit: "" // LfoShape
    },
    11: {
        type: "int32", name: "rateSync", pointerRules: ModulatorParameterPointerRules, value: 4, // LfoModulatorBoxAdapter.RatePPQNs, one bar
    ...
    15: {type: "float32", name: "exponent", pointerRules: ModulatorParameterPointerRules, value: 0.0, ...BipolarConstraints}
})
