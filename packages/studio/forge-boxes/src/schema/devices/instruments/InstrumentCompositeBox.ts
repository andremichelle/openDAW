...
// engine sums them into one output (see the composite mechanism in the wasm engine). Each cell (InstrumentCompositeCellBox)
...
export const InstrumentCompositeBox: BoxSchema<Pointers> = DeviceFactory.createInstrument("InstrumentCompositeBox", "notes", {
    10: {type: "field", name: "cells", pointerRules: {accepts: [Pointers.InstrumentCompositeCell], mandatory: false}}
})
